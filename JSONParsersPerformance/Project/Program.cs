...
namespace JSONParsersPerformance
{
    class Program
    {
            ...
            if (null != SR)
            {
                ...
                for (int i = 0; i < testCount; ++i)
                {
                    ...
                    switch (i)
                    {
                        ...
                        case 14: TryParseContent_MiniJSON20130602(content); break;
                        default: break;
                    }
        ...
        static void TryParseContent_SimpleJSON_20170411_JSONTextModeToString(string _Content)
        {
        ...
        static void TryParseContent_LightJson022(string _Content)
        {
        ...
        static void TryParseContent_MiniJSON20130602(string _Content)
        {
            var node = MiniJSON_20130602.Json.Deserialize(_Content);
        }
